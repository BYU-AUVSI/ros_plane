    ...
    nh_private_(ros::NodeHandle("~"))
{
  ...
  nh_private_.param<double>("landing_va", params_.landing_va, 15.0);
  nh_private_.param<double>("landing_alt", params_.landing_alt, 2.0);
  nh_private_.param<double>("landing_angle_deg", params_.landing_angle_deg, 5.0);
