...
path_manager_example::Path path_manager_example::generate_path(const struct params_s &params, int idx_z, int idx_a,
                                                               int idx_b, int idx_c, int subpath_index)
{
...
path_manager_example::Path path_manager_example::generate_line_path(const struct params_s &params, int idx_a, int idx_b,
                                                                    int idx_c)
{
  Path path;
...
path_manager_example::Path path_manager_example::generate_fillet_path(const struct params_s &params, int idx_z,
                                                                      int idx_a, int idx_b, int idx_c, int path_index)
{
...
path_manager_example::Path path_manager_example::generate_dubins_path(const struct params_s &params, int idx_a,
                                                                      int idx_b, int idx_c, int path_index)
{
  Path path;
  output_s &output = path.output;
...
rosplane::path_manager_example::dubinspath_s path_manager_example::dubinsParameters(const waypoint_s start_node,
                                                                                    const waypoint_s end_node, float R)
{
